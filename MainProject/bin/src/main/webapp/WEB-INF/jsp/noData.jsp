            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">검색 조건에 맞는 학원이 없습니다.</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="https://www.studysenior.com/Main.do">더 많은 정보가 있는 공부선배로 가기</a></li>
                            <li class="breadcrumb-item"><a href="https://www.gangmom.kr/search-institute/filter">더 많은 정보가 있는 강남엄마로 가기</a></li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                <p class="mb-0">
                                	<center>
                                    	<img alt="사진이 없습니다." src="/image/236267435756B7DC0F.jpeg" style="">
                                	</center>
                                </p>
                            </div>
                        </div>
