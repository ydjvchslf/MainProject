	        ...
	        <div class="container-fluid"  >
				...
				<!-- 학원 이름, 전화번호 -->
					...
					<div class="col-md-4">
							 ...
							 <button class="btn btn-primary" id="update" value="${review.reviewNo}" style="margin-left: 10; margin-bottom: 5;">수 정</button>
							 <button class="btn btn-primary" id="delete" value="${review.reviewNo}" style="margin-left: 10; margin-bottom: 5;">삭 제</button>
							 </c:if>
